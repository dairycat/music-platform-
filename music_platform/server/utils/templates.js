...
<html lang="zh">
  ...
  <body>
    <div class="container">
      ...
      <h1 class="heading">
        Welcome to Mawjat! We are thrilled to have you join our music
        community. 🎉
      </h1>
      <p class="paragraph">
        With Mawjat, you can access millions of songs and podcasts, create your
        own playlists, and discover new music that suits your taste. 🎧
      </p>
      <p class="paragraph">
        To get started, simply download the Mawjat app or visit our website,
...
<html lang="en">
  ...
  <body>
    <div class="container">
      ...
      <p class="paragraph">
        We're sorry to hear that you're having trouble accessing your Mawjat
